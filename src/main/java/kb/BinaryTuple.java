...
public class BinaryTuple
{
    ...
    */
    ...
    public String toHTML()
    {
        ...
        html += " <TD>" + 
            chargerlib.XMLGenerator.quoteForXML( concept1_label.toString().trim() ) + "\n";
        
        html += " <TD>" + 
        		chargerlib.XMLGenerator.quoteForXML( relation_label.toString().trim() ) + "\n";
        
        html += " <TD>" + 
        		chargerlib.XMLGenerator.quoteForXML( concept2_label.toString().trim() ) + "\n";
        return html;
    }
