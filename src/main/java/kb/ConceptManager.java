...
//                                ArrayList v = makeTableEntryArrayList( c1, rel, c2, selector );
    ...
    protected static ArrayList makeTableEntryArrayList(
            Concept c1, charger.obj.GNode rel, Concept c2, ConceptsToInclude selector ) {
    ...
    public static String convertTriplesToHTMLtable( ArrayList triples, String summary ) {
        String XMLSummary = chargerlib.XMLGenerator.quoteForXML( summary.trim() );
    ...
    public static String binaryRelationTableEntryToHTML( ArrayList tableEntry ) {
        ...
        html += " <TD>"
                + chargerlib.XMLGenerator.quoteForXML( tableEntry.get( col ).toString().trim() ) + "\n";
...
//
     ...
     */
    private static boolean swapBinaryRelation( Concept c1, charger.obj.GNode rel, Concept c2 ) {
...
//                );
//    }
    public static String makeSentence( Concept c1, charger.obj.GNode rel, Concept c2 ) {
    ...
    public static String makeSentenceOLD( Concept c1, charger.obj.GNode rel, Concept c2 ) {
        String c1label = null;
        String c2label = null;
        String rlabel = null;
